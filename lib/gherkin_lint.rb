...
require 'gherkin_lint/linter/prezi_avoid_chars_in_outline'
require 'gherkin_lint/linter/prezi_avoid_quotes'
require 'gherkin_lint/linter/prezi_avoid_steps_containing'
require 'gherkin_lint/linter/prezi_fs_inside_feature'
require 'gherkin_lint/linter/prezi_fs_on_separate_lines'
require 'gherkin_lint/linter/prezi_missing_platform_tag'
require 'gherkin_lint/linter/prezi_missing_team_tag'
require 'gherkin_lint/linter/prezi_tags_fs_order'
require 'gherkin_lint/linter/prezi_tags_inside_feature'
require 'gherkin_lint/linter/prezi_tags_on_separate_lines'
require 'gherkin_lint/linter/prezi_use_given_when_then_once'
