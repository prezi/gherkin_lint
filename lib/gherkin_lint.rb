...
require 'gherkin_lint/linter/prezi_avoid_characters_in_outline_example'
require 'gherkin_lint/linter/prezi_avoid_sentences_containing'
require 'gherkin_lint/linter/prezi_avoid_quotes'
require 'gherkin_lint/linter/prezi_fs_tags_location'
require 'gherkin_lint/linter/prezi_fs_tags_order'
require 'gherkin_lint/linter/prezi_given_when_then'
require 'gherkin_lint/linter/prezi_missing_tags'
require 'gherkin_lint/linter/prezi_tags_seperate_lines'
