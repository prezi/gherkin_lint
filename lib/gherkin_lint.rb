...
require 'gherkin_lint/linter/prezi_fs_location'
require 'gherkin_lint/linter/prezi_fs_separate_lines'
require 'gherkin_lint/linter/prezi_fs_tags_order'
require 'gherkin_lint/linter/prezi_given_when_then'
require 'gherkin_lint/linter/prezi_missing_platform_tag'
require 'gherkin_lint/linter/prezi_missing_team_tag'
require 'gherkin_lint/linter/prezi_tags_location'
require 'gherkin_lint/linter/prezi_tags_separate_lines'
